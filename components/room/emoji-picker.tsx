...
const EMOJI_CATEGORIES = [
  {
    ...
    emojis: [
      ...
      "\u{1F525}", "\u{2764}", "\u{1F495}", "\u{1F48B}", "\u{1F49C}",
  ...
  },
  {
    name: "Gestures",
    emojis: [
      "\u{1F44B}", "\u{270C}", "\u{1F91F}", "\u{1F919}", "\u{1F44C}",
      "\u{1F448}", "\u{1F449}", "\u{1F446}", "\u{1F447}", "\u{270D}",
      "\u{1F4AA}", "\u{1F9D1}", "\u{1F483}", "\u{1F57A}",
  ...
  },
  {
    ...
    emojis: [
      ...
      "\u{1F4F1}", "\u{1F48E}", "\u{1F451}", "\u{1F396}", "\u{1F3C6}",
